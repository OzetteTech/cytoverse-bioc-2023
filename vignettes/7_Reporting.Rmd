...
Also, as noted in the section [Visualizations](5_ggcyto.Rmd), the `ggcyto` makes use of the `ggplot2` framework providing a familiar user interface. Importantly, this allows users to prepare intricate figures for events within the `GatingSet`.
