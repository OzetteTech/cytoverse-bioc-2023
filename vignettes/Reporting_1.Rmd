---
title: "Reporting: Bringing Everything Eogether"
output: rmarkdown::html_vignette
---

# Background

The final step in the analysis of flow cytometry data is **Reporting**. At this stage, we bring all the tools that we have ...[COMPLETE THIS]
...
# get GatingSet
source("../../cytoverse-bioc-2023/R/workshop_gs.R")
```
